---
name: teach
description: 'Teach the user a new skill or concept through a persistent workspace curriculum. Manual-only; invoke explicitly when the user wants a structured, multi-session learning path rather than a one-off explanation.'
license: MIT
compatibility: Requires file-write access; network access is needed to research and cite current primary sources.
